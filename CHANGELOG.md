...
the equivalent CIDv1 CID (or the reverse). This hack will eventually (likely in the next release)
be replaced with a multihash indexes blockstore, which is agnostic to both the
